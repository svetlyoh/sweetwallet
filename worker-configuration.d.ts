/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5a42290a41fd94bc700415333d3a87c2)
...
interface __BaseEnv_Env {
	...
	SUGAR_API_URL: "https://api.sugar.wtf";
	HTTPS_PORT: string;
	LOCAL_LAN_IP: string;
	HTTPS_CERT_PATH: string;
	HTTPS_KEY_PATH: string;
	KEYLINK_SECRETS: DurableObjectNamespace<import("./cloudflare-worker").KeylinkSecret>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./cloudflare-worker");
		durableNamespaces: "KeylinkSecret";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SWEETWALLET_FUNDING_ADDRESS" | "SWEETWALLET_STARTER_FUNDING_ENABLED" | "SUGAR_API_URL" | "HTTPS_PORT" | "LOCAL_LAN_IP" | "HTTPS_CERT_PATH" | "HTTPS_KEY_PATH">> {}
}
